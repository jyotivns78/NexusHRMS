                            ...
                            <div className="form-group w-100">
                                <div className="Typeahead Typeahead--twitterUsers">
                                    <div className="search-bg" >
                                        ...
                                        <Input className={`form-control-plaintext searchIcon ${openResp ? 'open' : ''}`} type="text" placeholder="Search Employee" defaultValue={searchValue} onChange={(e) => handleSearchKeyword(e.target.value)} />
