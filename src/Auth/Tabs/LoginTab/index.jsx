    ...
    <div className='login-wrapper'>
        ...
        <Form className="theme-form">
          <div className='contain'>
            ...
            <div className="form-group mb-0">
              ...
              <Btn attrBtn={{ color: 'primary', className: 'btn-block' }} onClick={loginAuth}>Login</Btn>
              {loginStatus && <h1 style={{ color: "red", fontSize: "13px", marginTop: "210px", marginLeft: "85px" }}>{loginStatus}</h1>}
      ...
      <div className='right-side'>
        <div className="carousel-contain">
          <Carousel interval={2500} prevIcon={false} nextIcon={false} indica className="car">
